...
name: ui-ux-pro-max
description: >-
  Design intelligence for professional UI/UX (web and mobile): run bundled Python search for design
  systems, 67+ styles, color palettes, typography pairings, UX guidelines, charts, and stack-specific
  rules. Use when building or refining UIs, landing pages, dashboards, design systems, accessibility,
  or visual polish; or when the user mentions UI UX Pro Max / this skill name.
---
...
**Upstream:** [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) (MIT). Refresh bundled files with: `npm i -g uipro-cli && uipro init --ai cursor --force` (from this repo root).

## Skill location (`search.py`)

This project installs the skill at **`.cursor/skills/ui-ux-pro-max/`**. From the **repository root**, use:

`python3 .cursor/skills/ui-ux-pro-max/scripts/search.py ...`

If you only have a **user-level** copy, it may live at `~/.cursor/skills/ui-ux-pro-max/scripts/search.py` instead—adjust the path accordingly.
